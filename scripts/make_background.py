...
Usage:
    python3 scripts/make_background.py <source.png> [brightness]
...
Example:
    python3 scripts/make_background.py ~/Desktop/my_background.png 0.5
    python3 scripts/make_background.py ~/Desktop/my_background.png 0.6
...
# Output path relative to project root (where this script lives in scripts/)
SCRIPT_DIR  = os.path.dirname(os.path.abspath(__file__))
PROJECT_DIR = os.path.dirname(SCRIPT_DIR)
OUTPUT_PATH = os.path.join(PROJECT_DIR, 'components', 'display', 'background.c')
...
/* Generated by scripts/make_background.py — do not edit by hand.
 * Source: {source}
